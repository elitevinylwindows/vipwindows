...
<style>
    ...
    .msg-search input {
        ...
        border: 1px solid rgba(0,0,0,.1); border-radius: .375rem;
        background: #fafaf7;
    }
    ...
    .msg-bubble .bubble-time {
        font-size: .6rem; margin-top: 4px; display: block;
    }
    ...
    <div class="msg-chat">
        ...
        <div class="msg-chat-body" id="chatBody">
            <div class="msg-empty-state">
                ...
                <p>Select an installer to start chatting</p>
            </div>
        </div>
...
function loadConversation(id) {
    ...
    .then(data => {
        ...
        document.getElementById('chatTitle').textContent = conv.installer?.name || 'Installer';
...
function sendMessage() {
    ...
    fetch(`/admin/messages/${currentConvId}/send`, {
        method: 'POST',
        headers: {
...
// Poll for unread count badge in sidebar
setInterval(() => {
