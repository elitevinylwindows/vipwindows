...
<div class="p-4">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb small">
            ...
            <li class="breadcrumb-item active">Interior Colors</li>
        </ol>
    </nav>

    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="fw-bold mb-0" style="color: var(--vip-primary);">
            <i class="bi bi-house me-2" style="color: var(--vip-accent);"></i>Interior Colors
        </h4>
                        ...
                        @forelse($colors as $i => $color)
                            <tr data-search="{{ strtolower($color->code . ' ' . $color->name) }}">
                                ...
                                <td class="text-end pe-4">
                                    ...
                                    <form action="{{ route('admin.master.colors.interior.destroy', $color->id) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted py-5">
                                    ...
                                    No interior colors found. Click <strong>Add Color</strong> to create one.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('admin.master.colors.interior.store') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header" style="background: var(--vip-primary); color: #fff;">
                    <h5 class="modal-title"><i class="bi bi-plus-lg me-2"></i>Add Interior Color</h5>
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
        <form id="editForm" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background: var(--vip-primary); color: #fff;">
                    <h5 class="modal-title"><i class="bi bi-pencil me-2"></i>Edit Interior Color</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
...
<script>
    ...
    document.getElementById('editModal').addEventListener('show.bs.modal', function (event) {
        ...
        document.getElementById('editForm').action = '{{ url("admin/master/colors/interior") }}/' + btn.getAttribute('data-id');
